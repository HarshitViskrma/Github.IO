    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta name='description' content='Aenosh Rajora Contact'/>
                <meta name='keywords' content='Aenosh Rajora, AR, Aenosh , Rajora, Contact'/>
                ...
                <meta property='og:description' content='Aenosh Rajora Contact'/>
                ...
                <meta property='twitter:description' content='Aenosh Rajora Contact'/>

                <title>Aenosh Rajora &mdash; Contact with me</title>
            </Head>
                ...
                <div className={styles.contactCards}>
                    ...
                    <div className={styles.contactCardsCard}>
                        <ul className={styles.contactCardsCardList}>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Gmail:</span>
                                <a href="mailto:aenoshrajora79@Gmail.com">Aenosh Rajora</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>ProtonMail:</span>
                                <a href="mailto:aenoshrajora79@ProtonMail.com">Aenosh Rajora</a>
                            </li>
                            <li className={styles.contactCardsCardListItem}>
                                <span>Discord:</span>
                                <span>AenoshRajora#0807</span>
                            </li>
                        </ul>
                    </div>
                    <div className={styles.contactCardsCard}>
