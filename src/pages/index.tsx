...
const Home: NextPage = (props: any) =>
{
    ...
    return (
        <Fragment>
            <Head>
                <title>Aenosh Rajora &mdash; Penetration Tester</title>
            </Head>
            ...
            <section className={styles.home}>
                <header className={styles.homeHeader}>
                    ...
                    <div className={styles.homeHeaderLogs}>
                        ...
                        <div className={styles.homeHeaderLogsBox}>
                            <span className={styles.homeHeaderLogsBoxNumber}>65+</span>
                            <p className={styles.homeHeaderLogsBoxParagraph}>{t('home:headers.2.projects')}</p>
                        </div>
                        <div className={styles.homeHeaderLogsBox}>
                            <span className={styles.homeHeaderLogsBoxNumber}>02+</span>
                            <p className={styles.homeHeaderLogsBoxParagraph}>{t('home:headers.3.experience')}</p>
                        </div>
                        <div className={styles.homeHeaderLogsBox}>
                            <span className={styles.homeHeaderLogsBoxNumber}>03+</span>
