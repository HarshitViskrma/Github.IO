    ...
    return (
        <Fragment>
            <Head>
                ...
                <meta name='description' content='Aenosh Rajora Project'/>
                <meta name='keywords' content='Aenosh Rajora, AR, Aenosh , Rajora, Project'/>
                <meta name='author' content='Aenosh Rajora'/>

                <meta property='og:type' content='website'/>
                <meta property='og:url' content='https://aenoshrajora.netlify.app/projects'/>
                <meta property='og:title' content='Aenosh Rajora'/>
                <meta property='og:description' content='Aenosh Rajora Projects'/>
                <meta property='og:image' content='https://aenoshrajora.netlify.app/favicon.png'/>

                <meta property='twitter:card' content='summary'/>
                <meta property='twitter:url' content='https://aenoshrajora.netlify.app/Projects'/>
                <meta property='twitter:title' content='Aenosh Rajora'/>
                <meta property='twitter:description' content='Aenosh Rajora Projects'/>

                <title>Aenosh Rajora &mdash; Projects</title>
            </Head>
